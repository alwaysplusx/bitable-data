...
import com.harmony.bitable.oapi.filter.RecordSearchCustomizer
...
interface BitableRepository<T : Any, ID> : CrudRepository<T, ID> {
    ...
    fun scanWithCustomizer(
        pageable: Pageable = Pageable(),
        searchCustomizer: RecordSearchCustomizer = RecordSearchCustomizer.NoOpCustomizer
    ) = scan(pageable, searchCustomizer::customize)
